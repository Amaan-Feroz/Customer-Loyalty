...
class userPortal:
    ...
    def __init__(self, win) -> None:
        ...
        self.win.title("Customer Loyalty System")
        width = int(self.win.winfo_screenwidth() * 0.8)
        height = int(self.win.winfo_screenheight() * 0.8)
    ...
    def productPage(self, err = 0): 
        ...
        welcomeLabel = Label(self.header, text="Welcome to BingeBuddies", fg="#FFFFFF",background='blue', font=("Arial", 30))
        ...
        self.footer.place(x=20, y=620, width=1240, height=70)  # Adjusted coordinates

        self.logoutButton = customtkinter.CTkButton(master=self.win, text="Log Out", width=100, height=40, command=self.logout)
        self.logoutButton.place(x=520, y=645)  # Adjusted coordinates
        ...
        self.purchaseButton.place(x=720, y=645)  # Adjusted coordinates
...
# Final Page to see bill and checkout
    def checkoutPage(self):
        ...
        self.check.place(x = 600,y=100,width = 800,height=600)
        ...
        self.FlogoutButton.place(x = 850,y = 505)
